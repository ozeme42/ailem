...
import { Account, Transaction, getEffectiveMonth } from '../lib/data';
...
export default function BudgetReportsScreen() {
  ...
  const monthlyStats = useMemo(() => {
    ...
    for (let i = 5; i >= 0; i--) {
      ...
      const mtx = transactions.filter(tx => tx.isApplied && getEffectiveMonth(tx.date, tx.accountId, accounts) === monthStr);
