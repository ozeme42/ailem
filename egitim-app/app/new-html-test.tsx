      ...
      <View className="p-4 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex-row items-center z-10 shadow-sm">
        ...
        <View>
          <Text className="text-lg font-extrabold text-slate-900 dark:text-white leading-none">
            {isEditing ? 'Testi DÃ¼zenle' : (reassign === 'true' ? 'Testi Tekrar Ata' : 'Yeni HTML Testi')}
          </Text>
          <Text className="text-[9px] font-black text-slate-450 dark:text-slate-400 uppercase tracking-widest mt-1">HTML FormatÄ±nda SÄ±nav</Text>
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        <View className="space-y-6">
          ...
          <View className="flex-row gap-4">
            ...
            <View className="flex-1">
              <Text className="text-[10px] font-bold text-slate-450 dark:text-slate-400 uppercase tracking-wider mb-2">Soru SayÄ±sÄ±</Text>
              <TextInput
                value={questionCount}
          ...
          <View className="flex-1">
            <View className="flex-row items-center justify-between mb-2">
              <Text className="text-[10px] font-bold text-slate-450 dark:text-slate-400 uppercase tracking-wider">Sorular (HTML Ä°Ã§eriÄŸi)</Text>
              <TouchableOpacity onPress={() => setHtmlContent(sampleHtmlPlaceholder)} className="flex-row items-center bg-slate-100 dark:bg-slate-800 px-2 py-1 rounded-md">
                ...
                <Text className="text-[9px] font-bold text-indigo-600 dark:text-indigo-400 uppercase">Ã–rnek Ekle</Text>
              </TouchableOpacity>
            </View>
