...
export default function NewJsonTestScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert("JSON HatasÄ±", "GirdiÄŸiniz JSON verisi geÃ§ersiz. LÃ¼tfen formatÄ± kontrol edin.");
      return;
    }
      ...
      <View className="p-4 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex-row items-center z-10 shadow-sm">
        ...
        <View>
          <Text className="text-lg font-extrabold text-slate-900 dark:text-white leading-none">
            {isEditing ? 'Testi DÃ¼zenle' : (reassign === 'true' ? 'Testi Tekrar Ata' : 'Yeni YazÄ±lÄ±')}
          </Text>
          <Text className="text-[9px] font-black text-slate-450 dark:text-slate-400 uppercase tracking-widest mt-1">JSON FormatÄ±nda SÄ±nav</Text>
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        <View className="space-y-6">
          ...
          <View>
            ...
            <TextInput
              placeholder="1. DÃ¶nem 2. YazÄ±lÄ± vb."
          ...
          <View className="flex-1">
            <View className="flex-row items-center justify-between mb-2">
              <Text className="text-[10px] font-bold text-slate-450 dark:text-slate-400 uppercase tracking-wider">Sorular (JSON FormatÄ±)</Text>
