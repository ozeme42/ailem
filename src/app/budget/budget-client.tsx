                        ...
                        <Card className="shadow-lg bg-gradient-to-br from-blue-500 to-purple-600 text-white">
                            <CardHeader>
                             ...
                             <CardContent className="grid grid-cols-3 gap-4 text-left text-xs">
                                <div><p className="text-white/80">Varlıklar</p><p className="font-semibold text-base">{accountStats.totalAssets.toLocaleString('tr-TR', { style: 'currency', currency: 'TRY' })}</p></div>
                                <div><p className="text-white/80">Borçlar</p><p className="font-semibold text-base text-red-300">{accountStats.totalDebts.toLocaleString('tr-TR', { style: 'currency', currency: 'TRY' })}</p></div>
                                <div><p className="text-white/80">Net Değer</p><p className={cn("font-semibold text-base", accountStats.netWorth < 0 && 'text-red-300')}>{accountStats.netWorth.toLocaleString('tr-TR', { style: 'currency', currency: 'TRY' })}</p></div>
                            </CardContent>
                        </Card>
