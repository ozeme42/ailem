...
import { PdfTestsClient } from './pdf-tests-client';
import { Skeleton } from '@/components/ui/skeleton';

export const metadata = {
  title: "PDF Test Yönetimi | Ailem",
  description: "PDF tabanlı interaktif testler oluşturun ve yönetin.",
};

export default function PdfTestsPage() {
  return (
    <Suspense fallback={<PdfTestsSkeleton />}>
      <PdfTestsClient />
    </Suspense>
  );
}

function PdfTestsSkeleton() {
  return (
