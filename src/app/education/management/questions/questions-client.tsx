  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans relative flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full p-4 md:p-6 relative z-10 flex flex-col">
          ...
          {imagePreview && (<div className="fixed inset-0 z-[100] bg-slate-900/95 backdrop-blur-md flex items-center justify-center p-2 sm:p-4" onClick={() => setImagePreview(null)}><div className="relative w-full h-full bg-transparent flex items-center justify-center"><NextImage src={imagePreview} alt="Preview" fill className="object-contain" /><button onClick={() => setImagePreview(null)} className="absolute top-2 right-2 sm:top-4 sm:right-4 bg-white/10 hover:bg-white/20 p-3 rounded-2xl text-white backdrop-blur z-50"><X className="w-6 h-6"/></button></div></div>)}
        </main>
                                ...
                                <DropdownMenuContent align="end" className="w-48 bg-slate-900 border-white/10 text-slate-100 rounded-xl p-1 mb-2">
                                    ...
                                    <AlertDialog>
                                        ...
                                        <AlertDialogContent className="bg-slate-900 border-white/10 text-slate-100 rounded-3xl">
                                            ...
                                            <AlertDialogFooter><AlertDialogCancel className="bg-white/5 border-white/10 text-white">İptal</AlertDialogCancel><AlertDialogAction onClick={handleDeleteSelected} className="bg-rose-600 hover:bg-rose-700">Evet, Sil</AlertDialogAction></AlertDialogFooter>
                                        </AlertDialogContent>
                                    </AlertDialog>
                                </DropdownMenuContent>
                            </DropdownMenu>
