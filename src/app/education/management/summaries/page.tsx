...
import { SummariesManagementClient } from './summaries-client';
import { Skeleton } from '@/components/ui/skeleton';

export const metadata = {
  title: "Özet Yönetimi | Eğitim Paneli",
  description: "Ders özetlerini merkezi bir yerden yönetin.",
};

export default function SummariesManagementPage() {
  return (
    <Suspense fallback={<SummariesSkeleton />}>
      <SummariesManagementClient />
    </Suspense>
  );
}
