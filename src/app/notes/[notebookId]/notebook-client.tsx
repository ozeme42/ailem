                                ...
                                <Reorder.Item key={section.id} value={section} as="div" className="group relative pr-2" style={{cursor: 'grab'}}>
                                    <TabsTrigger
                                        ...
                                        className={cn(
                                            ...
                                            section.color,
                                            "data-[state=active]:ring-2 data-[state=active]:ring-offset-2 data-[state=active]:ring-ring data-[state=active]:opacity-100",
                            ...
                            return (
                                <AccordionItem key={folderName} value={folderName} className="border-b-0 overflow-hidden sm:rounded-lg">
                                    <div className="flex flex-col">
                                        <AccordionTrigger className={cn("flex items-center gap-4 text-white p-0 cursor-pointer rounded-none sm:rounded-lg shadow-lg border-0 hover:no-underline", `bg-gradient-to-br ${colorClass}`)}>
                                             <div className="bg-white/20 text-white flex items-center justify-center rounded-lg shrink-0 size-12 self-stretch m-2">
                                                <Folder className="h-6 w-6"/>
                                            </div>
                                            <div className="flex flex-col justify-center min-w-0 text-left py-3">
                                             ...
                                             {folderName !== "Genel Notlar" && (
                                                <AlertDialog>
                                                    <AlertDialogTrigger asChild>
                                                        <Button variant="ghost" size="icon" className="ml-auto mr-2 h-8 w-8 text-white/70 hover:text-white hover:bg-white/20 shrink-0" onClick={(e) => e.stopPropagation()}>
