...
import { Plus, ArrowLeft, ListChecks, Notebook, Edit, Home, Cake, ShoppingCart, Trash2, MoreVertical, CheckCircle2, Search, Sparkles, X, ChevronRight, Wallet } from "lucide-react";
  ...
  if (selectedList) {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-100 font-sans relative flex flex-col">
            {/* CRITICAL FIX: Sabit arkaplan katmanı. 
                İçerik ne kadar uzarsa uzasın bu katman sabittir.
            */}
            <div className="fixed inset-0 bg-slate-950 -z-50" />
            ...
            {/* Header - Sticky */}
            <div className={cn("sticky top-0 z-40 px-6 pt-8 pb-8 flex flex-col gap-6 shadow-2xl transition-all rounded-b-[2.5rem] border-b backdrop-blur-xl", theme.headerBg, "border-white/5")}>
            ...
            <div className="flex-1 flex flex-col relative z-10 mt-6">
                <Tabs defaultValue="pending" className="flex flex-col flex-1">
                    ...
                    <TabsContent value="pending" className="flex-1 px-6 pb-32 space-y-2 pt-0 focus-visible:outline-none">
                    ...
                    <TabsContent value="bought" className="flex-1 px-6 pb-32 pt-2 focus-visible:outline-none">
