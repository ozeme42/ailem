...
import { Home, ListTodo, CalendarDays, Library, ChevronsRight, GraduationCap, ShoppingCart, Zap, UtensilsCrossed } from "lucide-react";
...
export function AppSidebar() {
  ...
  const menuItems = [
    ...
    { href: "/actions", label: "İşlemler", icon: Zap },
  ];
